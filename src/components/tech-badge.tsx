...
export function TechBadge({ name, variant = 'olive', className }: TechBadgeProps) {
  ...
  return (
    <span
      className={cn(
        'inline-block rounded-full px-3 py-1 text-xs font-medium transition-all duration-200 hover:scale-105',
